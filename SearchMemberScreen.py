...
class SearchMemberScreen(Frame):

    def __init__(self, parent):
        Frame.__init__(self, parent)
        with open(LOG_FILENAME, APPEND_MODE) as f:
            f.write(TimeStamp() + INSTANCE_OF_SEARCHMEMBERSCREEN_TEXT + str(self) + PARENT_TEXT + str(parent) + "\n")
    ...
    def initialiseUI(self):
        ...
        TitleLabel = Label(text=SEARCH_FOR_MEMBERS_TEXT, font=("Purisa", 16))
        ...
        SearchTypeDropdown = OptionMenu(self.parent, SearchTypeVar,
                                        DROPDOWN_DISPLAY_NAME_TEXT,
                                        DROPDOWN_RANK_TEXT,
                                        DROPDOWN_ORIGINAL_RSN_TEXT,
                                        DROPDOWN_EMAIL_TEXT)
